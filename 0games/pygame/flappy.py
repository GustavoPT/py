...
images = {
    'start_thing': image.load('sprites/message.png'),
    'background': image.load('sprites/background-day.png'),
    'ground': image.load('sprites/base.png'),
    'pole': image.load('sprites/pipe-red.png'),
    'score_board': image.load('sprites/0.png')
    }
...
class Flappy_Class:
    ...
    def __init__(self):
        ...
        self.flap_1 = transform.scale(image.load('sprites/yellowbird-midflap.png'), (self.width, self.height))
        self.flap_2 = transform.scale(image.load('sprites/yellowbird-downflap.png'), (self.width, self.height))
        self.flap_3 = transform.scale(image.load('sprites/yellowbird-upflap.png'), (self.width, self.height))
